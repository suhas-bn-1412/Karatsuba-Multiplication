...
void compute_uh(char* str, int sz, char** uh)
{
...
void compute_lh(char* str, int sz, char** lh)
{
...
void str_add(char* a, char* b,char** res)
{
...
void str_sub(char* a, char* b, char** res)
{
...
void karatsuba(char* x, char* y, char** res)
{
	...
	else
	{
		...
		char* s1 = (char*)malloc(sizeof(char)*(2*strlen(lh_x) + 1));
		str_add(uh_x,lh_x,&s1);
		char* s2 = (char*)malloc(sizeof(char)*(2*strlen(lh_y) + 1));
		str_add(uh_y,lh_y,&s2);
		char* s3 = (char*)malloc(sizeof(char)*(2*max(strlen(a),strlen(d)) + 1));
		str_add(a,d,&s3);

		char* m = (char*)malloc(sizeof(char)*(2*max(strlen(s1),strlen(s2)) + 1));
		karatsuba(s1,s2,&m);
...
int main()
{
	...
	char* res = (char*)malloc(sizeof(char)*(2*dig + 1));
	scanf("%s",a);
	scanf("%s",b);
	...
	char* ans1 = (char*)malloc(sizeof(char)*(2*dig + 1));
	karatsuba(a,b,&ans1);
	printf("%s\n", ans1);
}
